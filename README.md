...
- Все тарелки *Ubiquiti* расположенные по офису соединяются с контроллером через один широковещательный домен L2 (на изображении ниже два кабеля подключаются на L2-свич от тарелок, третий от контроллера) ![Image of L2 switch](https://github.com/daduskacpokus/unifi/blob/master/img/1551786772429.JPEG)
